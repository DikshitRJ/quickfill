...
import { handleMountFile, handleRenderUi } from "./tools.js";
		...
		tools: [
			{
				...
				description:
					"Render or update an Alpine.js interactive UI in the browser.",
				inputSchema: {
					type: "object",
					properties: {
						html_body: {
						...
						required_libs: {
							...
							description:
								"Optional libraries to include (pdf.js, xlsx, tesseract.js).",
						},
						open_in_browser: {
							type: "boolean",
							description:
